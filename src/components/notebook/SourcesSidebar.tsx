...
const SourcesSidebar = ({
  ...
  const renderSourceIcon = (type: string) => {
    const iconMap: Record<string, string> = {
      ...
      'multiple-websites': 'https://yfvmutoxmibqzvyklggr.supabase.co/storage/v1/object/public/public-images/WEB.svg',
      'copied-text': 'https://yfvmutoxmibqzvyklggr.supabase.co/storage/v1/object/public/public-images/copy-icon.png'
    };
